...
export const artistsData = {
  'franta-agi': {
    name: 'Franta Ági',
    discipline: 'Tárgytervező',
    bio: `Franta Ági képzelete alakítja és formálja a tereket, miközben megtartja és megerősíti mindazt, amit funkcionalitásként, a tárgyak használati értékeként élünk meg. Lendülete, életigenlése magával ragad, érzelmei az anyagból új valóságot teremtenek. Új képzeletet, amelyet Te álmodhatsz tovább. `,
    contact: {
      email: 'franta.agi@gmail.com',
      website: 'https://www.frantaagi.com',
...
Hiszek abban, hogy az alkotás öröm. Ezt az élményt szeretném továbbadni workshopokon is: egy kiszállást a hétköznapokból, ahol együtt alkotunk, kapcsolódunk és békét találunk. Legyen szó csapatépítésről, leánybúcsúról vagy születésnapról vagy csak egy kis ÉN időről.
`,
    contact: {
      email: 'faficeramics@gmail.com',
      website: 'https://faficeramics.hu/',
...
`,
    contact: {
      email: 'korcsill@gmail.com',
      website: 'https://www.facebook.com/share/1FDogdFeDr/?mibextid=wwXIfr',
  ...
  'lantos-judit': {
    name: 'Lantos Judit',
    discipline: 'Keramikus',
    bio: `Alkotó tevékenységem során elsősorban az étkészletekre, konyhai és
háztartási eszközökre koncentrálok, emellett porcelán ékszereket, főleg gyűrűket készítek.
Szeretek anyagokkal, mázakkal, és új technikákkal kísérletezni.

Alkotásaim mindig egyediek: lehetnek ugyan hasonlóak, de soha
nem teljesen egyformák!

Remélem - apró tökéletlenségeiken és szabadságukon keresztül - ezek
az „anti-indusztriális” tárgyak örömet szereznek majd leendő tulajdonosaiknak.
Éttermek és egyéni ügyfelek megrendelései alapján dolgozom.
Rendszeresen tartok workshopokat különböző témákban.`,
    contact: {
      email: 'juditlantoskeramia@gmail.com',
      website: 'www.lantosjudit.hu',
...
~ Kényelmesen egyedi ~ Simple you

Elsődleges szempontom, a kényelem és a nőiesség mellett, hogy multifunkcionális ruhákat alkossak. Kollekcióim darabjai a hétköznapokra és némi kiegészítőve,  akár alkalmi viseletre is kiválóak, hiszen formavilágukban egyszerűek és letisztultak. 
Az anyagokat Hollandiából és Németországból rendelem, gondosan ügyelve az egyediségre és persze a minőségre. Igazából sohasem tudhatom előre, hogy a következő szezonban, milyen anyagokkal fogok dolgozni, mert a gyárban lévő kínálat sűrűn változik. E miatt a kollekcióim többnyire limitáltak, de természetesen létezik egy "basic " kollekció is, amelyre mindig lehet számítani.  

Alkotói irányelveim:

Összekötni a kintet a benttel.

A ruhán keresztül, összehangolni a testet a lélekkel, az aktuális belső állapotunkkal. Szavak nélkül kifejezve azt, aki abban a pillanatban vagyok! 

A fenntarthatóságot szem előtt tartva, az őrült tempóban változó divat trendek ellenében, hosszú élettartalmú, és egymással jól összekombinálható, egyedi ruhákat alkotni.

`,
    contact: {
      email: 'meminime.limited@gmail.com',
...
Egyszerű, konyhai kerámiákat készítek, illetve a keleti teakultúrák ismerőjeként megtalálhatók a kínálatomban ennek a területnek a speciális tárgyai is. A kerámia, mint hivatás mellett jelenleg a MOME mesterszakos hallgatója vagyok. 


`,
    contact: {
      email: 'mbdkeramik@gmail.com',
  ...
  'telegdi-balazs': {
    name: 'Telegdi Balázs',
    discipline: 'Üvegművész',
    bio: `Telegdi Balázs, szentendrei üvegművész, az üveg anyagi tulajdonságaiból merít ihletet.
Munkái a készítő és az anyag közötti párbeszéd eredményeként születnek, miközben kevésbé
ismert vagy váratlan reakciókat keres az olvadt anyagban. Úgy véli, hogy az üvegművészet
hosszú történelme ellenére mindig van valami új felfedezni való. Munkái mindig
anyagkísérletekként indulnak, ahol apró részleteket vagy nagyobb jelenségeket keres,
amelyek az új műalkotás középpontjává válhatnak.
2016-ban szerzett üvegtervezés szakon BA diplomát a Moholy-Nagy Művészeti Egyetemen,
majd 2020-ban üvegművészet szakon a Dán Királyi Akadémián.

Munkáit többek közt olyan intézményekben és eseményeken állították ki, mint a Velencei
Üveg Hét - Ateneo Veneto, a Belgrádi Iparművészeti Múzeum, a London Glassblowing
Gallery, a Szent István Bazilika, a Műcsarnok, a Prágai Vár és a dániai Glassmuseet Ebeltoft.

Megítélték neki a Magyar Művészeti Akadémia Művészeti ösztöndíját, a Moholy-Nagy
László Fotmatervezési Ösztöndíjat, a Kozma Lajos Kézműves Iparművészeti Ösztöndíjat és a Dán Művészeti Alap Művészeti ösztöndíját. 2021-ben elnyerte az 1. helyezést a Stanislav
Libensky Díjon, 2024-ben 2. helyezést a TRACE 2024: GAS Green Exhibition-on. 2023-ban
egy hónapot töltött a Corning Museum of Glass-ban, mint meghívott rezidens művész (Artist
in Residence), majd 2024-ben a Bukaresti UNARE egyetemen egy hetet vendégművészként.
2025-ben egy hetet töltött vendég művészként a Missouri állambeli Englewood Arts
üvegsúdiójában, majd Texasban mutatta be technikáit a szakmai közöznségnek a GAS
Conferenciáján.
`,
    contact: {
